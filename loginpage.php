					...
					<div class="row d-flex align-items-center" style="margin-top:10px;">
						<div class="col-lg-8">
							<div class="logintext">
								...
								<p>With special corporate rates on flights & hotels, save your travel budget by paying
									less for more
									features</p>
							</div>
						</div>
							...
							<div class="loginform">
								<form action="" method="post">
									<div class="formlogo">
										...
										<?php if ($notlogin == 1) { ?>
											<div style="margin:10px 0px; color:#CC0000; font-size:12px; font-weight:600;">
												Invalid Login!</div>
										<?php } ?>
									</div>
									<div class="inputbox">
									...
									<div class="reset">
										<p>Forgot your password ? <a style=" cursor:pointer; color:var(--blue);"
												onClick="loadpop('Reset Password',this,'500px')" data-toggle="modal"
												data-target=".bs-example-modal-center"
												popaction="action=resetpassword">Reset Here</a></p>
										<hr>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="cntbuttons">
							<a style="background: linear-gradient(135deg, #d72e36, #f95535);width: 40%; text-align: center;"
								href="<?php echo $fullurl ?>contactpage.php">Enquiry Now</a>
							<a style="background: #fff;color:var(--blue)"
								href="<?php echo $fullurl ?>contactpage.php">Contact Us</a>
						</div>
					</div>
				</div>
			</div>
