...
<div class="dashboardboxes">
  ...
  <a href="<?php echo $fullurl; ?>flights"><i class="fa fa-plane" aria-hidden="true"></i><h6>Flight</h6></a>

  <a href="<?php echo $fullurl; ?>hotels"><i class="fa fa-bed" aria-hidden="true"></i><h6>Hotels</h6></a>

  <a href="<?php echo $fullurl; ?>domestic-holidays"><i class="fa fa-suitcase" aria-hidden="true"></i><h6>Holidays</h6></a>
