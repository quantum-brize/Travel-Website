...
<strong><?php echo strip($agentData['firstName']); ?> <?php echo strip($agentData['lastName']); ?> <?php echo strip($agentData['lastName']); ?></strong>
	...
	<?php echo round($rest['agentTotalFare']+$ssrprice['BaggageFeeInn']+$ssrprice['MealFeeInn']+$ssrprice['SeatPriceInn'])-str_replace('-','',round($rest['markup'])); ?>
	 </strong>
...
<div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;  white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width:200px; margin-top:2px; color:#3366CC;">Comm.: <strong>&#8377;<?php echo ($rest['agentCommision']); ?></strong></div></td>
